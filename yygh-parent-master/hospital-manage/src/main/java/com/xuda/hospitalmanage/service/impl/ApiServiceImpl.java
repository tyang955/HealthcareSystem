package com.xuda.hospitalmanage.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.xuda.hospitalmanage.mapper.HospitalSetMapper;
import com.xuda.hospitalmanage.mapper.ScheduleMapper;
import com.xuda.hospitalmanage.model.HospitalSet;
import com.xuda.hospitalmanage.model.Schedule;
import com.xuda.hospitalmanage.service.ApiService;
import com.xuda.hospitalmanage.util.BeanUtils;
import com.xuda.hospitalmanage.util.HttpRequestHelper;
import com.xuda.hospitalmanage.util.MD5;
import com.xuda.hospitalmanage.util.YyghException;
...
public class ApiServiceImpl implements ApiService {
    ...
    public boolean saveHospital(String data) {
        System.err.println("进去啊==》"+data);
        System.err.println("进入Impl1");
        JSONObject jsonObject = JSONObject.parseObject(data);
        System.err.println("进入Impl2");
        System.err.println("医院管理接口的保存在Impl===>"+jsonObject);
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("hoscode",this.getHoscode());
        ...
        System.out.println(respone.toJSONString());
        System.err.println("转换完毕===》"+respone);
        if(null != respone && 200 == respone.getIntValue("code")) {
            return true;
        } else {
