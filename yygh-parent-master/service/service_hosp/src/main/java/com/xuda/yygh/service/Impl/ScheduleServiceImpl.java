...
import com.xuda.yygh.mapper.ScheduleMapper;
import com.xuda.yygh.repository.ScheduleRepository;
import com.xuda.yygh.service.DepartmentService;
import com.xuda.yygh.service.HospitalService;
import com.xuda.yygh.service.ScheduleService;
import com.xuda.yygh.model.hosp.BookingRule;
import com.xuda.yygh.model.hosp.Department;
import com.xuda.yygh.model.hosp.Hospital;
import com.xuda.yygh.model.hosp.Schedule;
import com.xuda.yygh.model.order.OrderInfo;
import com.xuda.yygh.vo.hosp.BookingScheduleRuleVo;
import com.xuda.yygh.vo.hosp.ScheduleOrderVo;
import com.xuda.yygh.vo.hosp.ScheduleQueryVo;
...
public class ScheduleServiceImpl extends
    ...
    public Map<String, Object> getRuleSchedule(long page, long limit, String hoscode, String depcode) {
        ...
        Aggregation agg = Aggregation.newAggregation(
                ...
                //3 统计号源数量
                .count().as("docCount")
                .sum("reservedNumber").as("reservedNumber")  //统计数量
                .sum("availableNumber").as("availableNumber"), //可以数量
                //排序
        ...
        //分组查询的总记录数 Aggregation:做求和和分组的操作
