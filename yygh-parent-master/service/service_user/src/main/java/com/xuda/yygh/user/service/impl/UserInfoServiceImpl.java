...
import com.xuda.yygh.enums.AuthStatusEnum;
import com.xuda.yygh.model.acl.User;
...
import com.xuda.yygh.user.service.UserInfoService;
...
public class UserInfoServiceImpl  extends
    ...
    //用户列表（条件查询带分页）
    @Override
    public IPage<UserInfo> selectPage(com.baomidou.mybatisplus.extension.plugins.pagination.Page<UserInfo> pageParam, UserInfoQueryVo userInfoQueryVo) {
...
/*
    ...
    public Map<String, Object> loginEmail(LoginVo loginVo) {
        ...
        String token = JwtHelper.createToken(userInfo.getId(), name);
        map.put("token",token);
        redisTemplate.delete(phone); //删除code
        return map;
    }
